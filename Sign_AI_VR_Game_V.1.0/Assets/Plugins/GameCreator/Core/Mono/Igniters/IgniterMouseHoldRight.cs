namespace GameCreator.Core
{
	...
	[AddComponentMenu("")]
    public class IgniterMouseHoldRight : Igniter, IPointerDownHandler, IPointerUpHandler, IPointerExitHandler
    {
        #if UNITY_EDITOR
        public new static string NAME = "Input/On Mouse Right Hold";
        public new static bool REQUIRES_COLLIDER = true;
        #endif

        private const PointerEventData.InputButton MOUSE_BUTTON = PointerEventData.InputButton.Right;
